...
namespace IntelliTaxi_Manager.Controllers
{
    ...
    public class ReviewsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,From_ID,For_ID,SendDate,Stars,Content")] Reviews reviews)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,From_ID,For_ID,SendDate,Stars,Content")] Reviews reviews)
        {
            if (ModelState.IsValid)
            {
