...
namespace IntelliTaxi_Manager.Controllers
{
    ...
    public class CompaniesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Name,City,Price,Admin_ID")] Companies companies)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,City,Price,Admin_ID")] Companies companies)
        {
            if (ModelState.IsValid)
            {
